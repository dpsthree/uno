...
<main class="mx-auto bg-white rounded p-8 shadow flex flex-col md:flex-row max-w-md md:max-w-5xl h-screen">
  <div class="flex flex-col flex-grow">
    ...
    <div class="mt-4 flex-grow border border-gray-300 rounded">
      {#if iframeBlobUrl}
        <iframe src={iframeBlobUrl} frameborder="0" title="Generated Web Application" class="w-full h-full" />
      {:else}
